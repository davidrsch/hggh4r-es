...
# Revisión mensual de cambios upstream: Happy Git and GitHub for the useR
...
- **Upstream:** `jennybc/happy-git-with-r`, rama `main`
...
`jennybc/happy-git-with-r` rama `main` de los últimos 30 días (desde
...
en la rama `main` de `jennybc/happy-git-with-r`.
